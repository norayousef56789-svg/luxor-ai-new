      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-32 md:py-44">
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            ...
            <Link
              to="/ask-luxor"
              className="inline-flex items-center gap-2 rounded-full border border-gold/40 bg-midnight/40 backdrop-blur px-6 py-3 text-sm font-medium text-gold hover:bg-midnight/60"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full border border-border/60 bg-midnight/40 backdrop-blur px-6 py-3 text-sm font-medium text-foreground/80 hover:text-gold"
            >
        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          {[
            ...
            <Link
              key={q.to}
              to={q.to}
              className="rounded-2xl border border-border/60 bg-card/50 p-6 hover:border-gold/40 transition"
            >
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          {[
            {
              icon: Sparkles,
              title: t("valueAskTitle"),
              desc: t("valueAskDescription"),
            },
            {
              icon: Compass,
              title: t("valueItinerariesTitle"),
              desc: t("valueItinerariesDescription"),
            },
            {
              icon: BookOpen,
              title: t("valueDepthTitle"),
              desc: t("valueDepthDescription"),
            },
